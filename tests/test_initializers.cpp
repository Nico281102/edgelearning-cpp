...
int main() {
    {
        using Model = edge::Model<edge::Input<2>, edge::Dense<3, edge::ReLU, edge::XavierUniform>>;
        Model a;
        Model b;
    ...
    {
        using Model = edge::Model<edge::Input<2>, edge::Dense<2, edge::Linear, edge::KaimingUniform>>;
        Model model;
    ...
    {
        using Model = edge::Model<edge::Input<3>, edge::Dense<2, edge::Linear, edge::Orthogonal>>;
        Model model;
    ...
    {
        using Model = edge::Model<edge::Input<2>, edge::Dense<1, edge::Linear, edge::Constant>>;
        Model model;
